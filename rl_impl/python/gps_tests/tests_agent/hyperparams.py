...
for i in xrange(common['conditions']):
    ...
    """
    ja_x0 = np.array([[0.40493573, -0.26709164, 0.9860822, -0.58687217,\
        -30.29001274, -0.59461712, 19.50285032]])
    ee_pos_x0 = np.array([[0.8978357, 0.21710517, 0.29041286]])
    ee_rot_x0 = np.array([[[0.83372763, -0.54771745, 0.07002733],\
        [-0.54459356, -0.83658433, -0.05953581],\
        [0.09119257, 0.01150022, -0.99576687]]])
    ja_aux = np.array([0., 0., 0., 0., 0., 0., 0.])
    ee_pos_tgt = np.array([[0.83093201, -0.05959223, -0.21891968]])
