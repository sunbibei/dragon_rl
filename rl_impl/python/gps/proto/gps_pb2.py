...
_SAMPLETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOOL_JOINT_ANGLES', index=19, number=19,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOOL_JOINT_VELOCITYIES', index=20, number=20,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOTAL_DATA_TYPES', index=21, number=21,
      options=None,
      type=None),
  ],
