...
#hyperparams_file = '/home/rick/pro/gps/experiments/pr2_example/hyperparams.py'
#hyperparams_file = '/home/silence/AboutRL/rl_impl/experiments/pr2_example/hyperparams.py'
#hyperparams = imp.load_source('hyperparams', hyperparams_file)
from gps_tests.tests_agent.dragon_hyperparams import config
defaults = config
...
def run_offline():
    ...
    """
    agent = setup_agent()
    defaults['algorithm']['agent'] = agent
