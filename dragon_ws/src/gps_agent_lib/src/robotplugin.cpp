...
#include "gps_agent_lib/lingausscontroller.h"
#include "gps_agent_lib/trialcontroller.h"
#include "gps_agent_lib/LinGaussParams.h"
#include "gps_agent_lib/tfcontroller.h"
#include "gps_agent_lib/TfParams.h"
...
#ifdef USE_CAFFE
#include "gps_agent_lib/caffenncontroller.h"
#include "gps_agent_lib/CaffeParams.h"
#endif
...
void RobotPlugin::initialize_ros(ros::NodeHandle& n)
{
    ...
    // Create publishers.
    report_publisher_.reset(new realtime_tools::RealtimePublisher<gps_agent_lib::SampleResult>(n, "/gps_controller_report", 1));
    ...
    tf_publisher_.reset(new realtime_tools::RealtimePublisher<gps_agent_lib::TfObsData>(n, "/gps_obs_tf", 1));
}
...
void RobotPlugin::position_subscriber_callback(const gps_agent_lib::PositionCommand::ConstPtr& msg){
    ...
    // ROS_WARN("if else end");
}

void RobotPlugin::trial_subscriber_callback(const gps_agent_lib::TrialCommand::ConstPtr& msg){
    ...
    if(msg->controller.controller_to_execute == gps::LIN_GAUSS_CONTROLLER){
        //
        gps_agent_lib::LinGaussParams lingauss = msg->controller.lingauss;
        ...
        gps_agent_lib::CaffeParams params = msg->controller.caffe;
        ...
        controller_params["T"] = (int)msg->T;
        gps_agent_lib::TfParams tfparams = msg->controller.tf;
...
void RobotPlugin::relax_subscriber_callback(const gps_agent_lib::RelaxCommand::ConstPtr& msg){
...
void RobotPlugin::data_request_subscriber_callback(const gps_agent_lib::DataRequest::ConstPtr& msg) {
...
void RobotPlugin::tf_robot_action_command_callback(const gps_agent_lib::TfActionCommand::ConstPtr& msg){
