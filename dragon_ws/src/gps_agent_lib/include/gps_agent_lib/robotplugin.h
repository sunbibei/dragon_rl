...
#include "gps_agent_lib/PositionCommand.h"
#include "gps_agent_lib/TrialCommand.h"
#include "gps_agent_lib/RelaxCommand.h"
#include "gps_agent_lib/SampleResult.h"
#include "gps_agent_lib/DataRequest.h"
#include "gps_agent_lib/TfActionCommand.h"
#include "gps_agent_lib/TfObsData.h"
...
protected:
    ...
    ros_publisher_ptr(gps_agent_lib::SampleResult) report_publisher_;
    ...
    //tf publisher
    ros_publisher_ptr(gps_agent_lib::TfObsData) tf_publisher_;
...
public:
    ...
    virtual void position_subscriber_callback(const gps_agent_lib::PositionCommand::ConstPtr& msg);
    // Trial command callback.
    virtual void trial_subscriber_callback(const gps_agent_lib::TrialCommand::ConstPtr& msg);
    virtual void test_callback(const std_msgs::Empty::ConstPtr& msg);
    // Relax command callback.
    virtual void relax_subscriber_callback(const gps_agent_lib::RelaxCommand::ConstPtr& msg);
    // Data request callback.
    virtual void data_request_subscriber_callback(const gps_agent_lib::DataRequest::ConstPtr& msg);
    //tf callback
    virtual void tf_robot_action_command_callback(const gps_agent_lib::TfActionCommand::ConstPtr& msg);
